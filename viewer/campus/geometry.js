...
export const materials={
 ...
 stone:std({color:0xd6d0c2,roughness:.74}),
 dark:std({color:0x2a333c,metalness:.42,roughness:.38}),
 ...
 copper:std({color:0xc47a48,metalness:.58,roughness:.42,emissive:0x4a2410,emissiveIntensity:.18}),
