...
The standard facility images and sheets were subsequently refreshed after the occupied-facade detail pass across all 35 facilities. For stronger visibility evidence, see `../facility-detail-review/`: six 900 × 650 BEFORE/AFTER pairs reuse exactly recorded camera parameters and show the added program equipment behind glazing. Those checks found improved visibility, not exact reference completion.
